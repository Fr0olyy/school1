document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.auth-form').addEventListener('submit', (e) => {
        e.preventDefault();
        const username = document.querySelector('.input-group input[name="username"]').value;
        const password = document.querySelector('.input-group input[name="password"]').value;
